          ...
          <div class="modal-dialog" style="width: 1000px;">
            <div class="modal-content">
              ...
              <div class="modal-body">
                       <div class="col-md-12">
               <form  autocomplete="off" method="POST" action="addacc_act.php" enctype="multipart/form-data">
                <div class="col-md-6 form-group">
          <input type="text" name="name" placeholder="Category" class="form-control input-lg">
             </div> 
             <div class="col-md-6 form-group">
