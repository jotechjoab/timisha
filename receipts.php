  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     <div class="col-md-12">
      ...
      <div class="col-md-12">
                <form  autocomplete="off" id="dateform" method="POST" action="customreceipts.php" >
