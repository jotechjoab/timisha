     ...
     <div class="row">
       <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Create Stock Request </h3>
        ...
        <div class="box-body">
         ...
         <input type="hidden" name="id" id="id" value="<?php echo $info['id'];?>"> 
          <table class="table table-bordered table-hover" id="example16">
               <thead>
                 <tr>
                   <th>#</th>
                   <th>Name</th>
        ...
        $sql="SELECT p.id as pid,t.id,p.item_code,p.name as pname,p.unit_of_measure,p.description,t.qty,t.rate,s.name as sname, d.name as dname  FROM products p, suppliers s, departments d, temp_sr t WHERE p.supplier_id=s.id AND d.id=p.dept AND t.pdt_code=p.item_code";
        $query=mysqli_query($con,$sql);
        if (mysqli_num_rows($query)>0) {
          $i=1;
          $button='<button type="submit" class="btn btn-primary">Generate SR</button>';
       $status="";   
          while ($row=mysqli_fetch_array($query)) {
           ...
           ';
            ...
            $button='<button type="submit" class="btn btn-primary" disabled="">Generate SR</button>';
            }    
  ...
  <div class="modal fade" id="modal-default">
          <div class="modal-dialog" style="width: 1000px;">
            <div class="modal-content">
              ...
              <div class="col-md-12">
                <input type="text" name="q" id="q" class="form-control" placeholder="Search...." onkeyup="getproduct(this.value,<?php echo $_GET['dept']; ?>)" autocomplete="off">
              </div>
