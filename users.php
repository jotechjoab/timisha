...
<head>
  ...
  <title>Hotel Power-Timisha  | Users </title>
...
<?php include 'aside.php';?>  
    ...
    <section class="content">
     <div class="row">
       ...
       $status='<u class="timeline"><li class="time-label"><span class="bg-red">Inactive</span></li></u>';       
        ...
        $pr=$row['profile_id'];
       $profile=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM profiles WHERE id='$pr'"));     
           echo '
             <tr>
                   <td>'.$i++.'</td>
                   ...
                   <td>'.$row['phone_no'].'</td>
                   <td>'.$profile['name'].'</td>
                   <td>'.date("d M Y h:m:s",strtotime($row['lastlogin_date'])).'</td>
                   <td><img src="'.$row['avater_path'].'" style="width:60px; border-radius:80px;"></td>
                   <td>'.$status.'</td>
                   <td>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="#" onclick="roles('.$row['id'].')">Assign Permission</a></li>
                  </ul>
                </div>
                   </td>
                 </tr>
  ...
  <div class="modal fade" id="modal-default">
          <div class="modal-dialog" style="width: 1000px;">
            <div class="modal-content">
              ...
              <div class="modal-body">
                       <div class="col-md-12">
               <form  autocomplete="off" method="POST" action="adduser.php" enctype="multipart/form-data">
                <div class="col-md-3 form-group">
          <input type="text" name="fname" placeholder="First Name" class="form-control input-lg">
             </div> 
             <div class="col-md-3 form-group">
          <input type="text" name="lname" placeholder="Last Name" class="form-control input-lg">
             </div> 
             <div class="col-md-3 form-group">
          <input type="text" name="oname" placeholder="Other Name" class="form-control input-lg">
             </div> 
             <div class="col-md-3 form-group">
          ...
          <input type="email" name="email" placeholder="E-Mail" class="form-control input-lg" required="">
              ...
              <div class="col-md-3 form-group">
          <input type="text" name="phone" placeholder="Phone" class="form-control input-lg" required="">
             </div> 
               <div class="col-md-3 form-group">
          <input type="file" name="img_url" placeholder="Image" class="form-control input-lg" required="">
   ...
   <div class="modal fade" id="roles">
          <div class="modal-dialog" style="width: 1000px;">
            <div class="modal-content">
              ...
              <div class="modal-body">
                       <div class="col-md-12">
               <form  autocomplete="off" method="POST" action="setrole.php" enctype="multipart/form-data">
                <div class="col-md-6 form-group">
                  <input type="hidden" name="userid" id="userid">
         <SELECT class="form-control" name="role">
           <?php 
           $p_query=mysqli_query($con,"SELECT * FROM profiles");
           while ($prof=mysqli_fetch_array($p_query)) {
             echo '<option value="'.$prof['id'].'">'.ucwords($prof['name']).'</option>';
           }
