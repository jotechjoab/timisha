...
<head>
  ...
  <title>Hotel Power-Timisha  | Receipts</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     <div class="col-md-12">
      ...
      <div class="col-md-12">
                <form  autocomplete="off" id="dateform" method="POST" action="customroomreceipts.php" >
...
$totalpaid=0;
$totalbaldue=0;
$sql="SELECT r.id,t.trans_date,r.trans_code,a.name,r.paymt_mode,r.cash_tendered,r.amount_paid,r.change_returned,r.balance_due,u.fname,u.lname,j.journal_type_id FROM users u,accounts a,receipts r,transactions t,journals j WHERE (u.id=r.created_by AND a.id=r.received_by) AND (r.trans_code=t.trans_code)AND j.id=t.journal_id AND j.description LIKE '%Booking%'";
...
$pay=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM pay_methods WHERE id='$mth'"));
    ...
    echo '<td>'.$i++.'</td>
       ...
       <td>'.$row['fname'].' '. $row['lname'].'</td>
        <td><a href="doc.php?msg=Transaction Successiful&trans_code='.$row['trans_code'].'&grp_id='.$row['journal_type_id'].'&place=Reprinted"><i class="fa fa-list" style="color:green;"></i> Receipt</a></td>
</tr>
