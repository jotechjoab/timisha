...
<head>
  ...
  <title>Hotel Power-Timisha  | Places</title>
        ...
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-default">
              <i class="fa fa-user-plus"></i> Add Place</button>
           ...
           echo '
             <tr>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="#" onclick="getplace('.$row['id'].')">Edit</a></li>
                    <li><a href="#" onclick="delplace('.$row['id'].')">Delete</a></li>
                  </ul>
                </div>
                   </td>
                 </tr>
          ...
          <div class="modal-dialog" style="width: 1000px;">
            <div class="modal-content">
              ...
              <div class="modal-body">
                       <div class="col-md-12">
               <form  autocomplete="off" method="POST" action="addplace.php" enctype="multipart/form-data">
                <div class="col-md-4 form-group">
          <input type="text" name="location" placeholder="Location eg. Gardens" class="form-control input-lg">
             </div> 
             <div class="col-md-4 form-group">
          <input type="text" name="tbl" placeholder="Table eg. Table 1" class="form-control input-lg">
             </div>
