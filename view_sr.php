     ...
     <div class="row">
       <div class="box">
        ...
        <div class="box-body">
         ...
         <input type="hidden" name="id" id="id" value="<?php echo $info['id'];?>"> 
          ...
          <?php
          $dept=$_GET['dept'];
        $sql="SELECT p.id,p.created_at,p.details_grp_id,p.approval_status,p.amount,p.status FROM sr p WHERE  p.dept='$dept' ORDER BY created_at DESC";
       ...
       $stat="";
          ...
          while ($row=mysqli_fetch_array($query)) {
            ...
            if ($row['status']=='Cleared' || $row['approval_status']=='Approved') {
           $action='<button type="button" class="btn btn-success fa fa-edit" onclick="editpodetail(\''.$group_id.'\','.$dept.')" disabled=""> </button>
                   <button class="btn btn-danger fa fa-trash" onclick=
                   "deleteitem(\''.$group_id.'\')" type="button" disabled=""></button>';
            }else{
            $action='<button type="button" class="btn btn-success fa fa-edit" onclick="editpodetail(\''.$group_id.'\','.$dept.')"> </button>
                   <button class="btn btn-danger fa fa-trash" onclick=
                   "deleteitem(\''.$group_id.'\')" type="button"></button>';
