...
<head>
  ...
  <title>Hotel Power-Timisha  | Bar  Sales</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     ...
     <div class="col-md-12">
      ...
      <div class="col-md-12">
                <form  autocomplete="off" id="dateform" method="POST" action="custom_bar_report.php" >
...
$sql="SELECT i.details_grp_id,t.trans_code,t.trans_date,p.id as item_code,p.name,d.quantity,d.rate,u.fname,u.lname,(d.quantity*d.rate) as totalprice,i.payment_status,p.dept FROM users u,menu_items p,invoice_details d, invoices i,transactions t WHERE  (u.id=d.created_by AND p.id=d.pdt_code) AND (d.details_grp_id=i.details_grp_id) AND (t.created_at=i.created_at AND p.dept=1)";
$results=mysqli_query($con,$sql);
if($results){
$color='#000';
?>
<h3 style='text-align:center'>Timisha Bar Sales Report </h3>
