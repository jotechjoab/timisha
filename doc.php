...
<head>
  ...
  <title>Hotel Power-Timisha  | Receipt</title>
        ...
        <div class="box-body">
         ...
         <div class="row">
            ...
            <div class="box-header">
              <h3 class="box-title">Print Preffered document Type</h3>
            </div>
            <div class="box-body">
...
<form id="invoice" action="invo.php" method="post">  
  <input type="hidden" name="group_id" value="<?php echo $group_id;?>">
  <input type="hidden" name="trans_code" value="<?php echo $trans_code;?>">

               <button  type="submit" class="btn btn-app pull-right">
                <span class="badge bg-green"><?php echo $name;?></span>
                <i class="fa fa-barcode"></i> Invoice
               </button> 
</form>
...
<form id="itill" action="till.php" method="post">
  <input type="hidden" name="group_id" value="<?php echo $group_id;?>">
  <input type="hidden" name="trans_code" value="<?php echo $trans_code;?>">
  <?php if(isset($_GET['place'])){
    echo '<input type="hidden" name="place" value="'.$_GET['place'].'">';
  } ?>

              <button type="submit" class="btn btn-app pull-left">
                <span class="badge bg-purple"><?php echo $name;?></span>
                <i class="fa fa-users"></i> Till receipt
              </button> 
