...
<head>
  ...
  <title>Hotel Power-Timisha  | Departmets</title>
        ...
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-default">
              <i class="fa fa-user-plus"></i> Add Dept</button>
           ...
           echo '
             <tr>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="#" onclick="getdept('.$row['id'].')">Edit</a></li>
                    <li><a href="#" onclick="deldept('.$row['id'].')">Delete</a></li>
                  </ul>
                </div>
                   </td>
                 </tr>
          ...
          <div class="modal-dialog" style="width: 1000px;">
            <div class="modal-content">
              ...
              <div class="modal-body">
                       <div class="col-md-12">
               <form  autocomplete="off" method="POST" action="adddept.php" enctype="multipart/form-data">
                <div class="col-md-6 form-group">
          <input type="text" name="name" placeholder="Dept Name" class="form-control input-lg">
             </div> 
