    ...
    <section class="content">
     <div class="row">
       <div class="box">
        ...
        $sql="SELECT p.created_at,p.details_grp_id,s.name as sname,p.approval_status,p.payment_status,p.amount,p.status FROM po p,suppliers s WHERE p.supplier_id=s.id";
       ...
       $stat="";
          ...
          while ($row=mysqli_fetch_array($query)) {
            ...
            if ($row['approval_status']!='Approved' && $row['payment_status']!='Full') {
             $to_in='disabled=""';
            }else{
              $to_in='';
            }
           ...
           echo '
             <tr>
                   ...
                   <button type="button" class="btn btn-success fa fa-edit" onclick="editpodetail(\''.$group_id.'\')"> </button>
                   <button type="button" class="btn btn-warning fa  fa-cart-plus" '.$to_in.' onclick="to_inventory(\''.$group_id.'\')" '.$status.'> </button>
